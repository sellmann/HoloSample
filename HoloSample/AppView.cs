...
namespace HoloSample
{
  ...
  {
    private HoloSampleMain main;

    private DeviceResources deviceResources;
    private bool windowClosed = false;
    private bool windowVisible = true;
    private WebRTCWrapper webRCTWrapper;
    ...
    public AppView()
    {
      ...
      webRCTWrapper = new WebRTCWrapper();
    }
    ...
    public void Initialize(CoreApplicationView applicationView)
    {
      ...
      main = new HoloSampleMain(deviceResources);
    }
    ...
    {
      //webRCTWrapper.Initialize("ws://172.16.5.38:3434/");
